...
noremap \fd :silent! 1,$!perl -nMDateTime::Format::DateParse -E"my $line = $_;chomp $line;my $dt = DateTime::Format::DateParse->parse_datetime($line);say $dt ? $dt->strftime('\%Y-\%m-\%d \%H:\%M:\%S') : $line"<CR>
