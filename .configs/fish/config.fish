function setEnvs
    set -gax JAVA_OPTS '-Xmx12G -XX:MaxInlineLevel=21 --enable-native-access=ALL-UNNAMED --add-opens=java.base/jdk.internal.misc=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED'
